  ...
  <footer class="bg-gray-900 text-gray-400">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div class="lg:col-span-1">
          ...
          <p class="text-sm leading-relaxed mb-6">
            Zamonaviy IT yechimlar orqali biznesingizni raqamli kelajakka olib chiqamiz.
          </p>
          <!-- Socials -->
        ...
        <div v-for="col in footerLinks" :key="col.title">
          <h4 class="text-white font-bold mb-5 text-sm uppercase tracking-wider">{{ col.title }}</h4>
          <ul class="space-y-3">
            <li v-for="link in col.links" :key="link.label">
              <a
                :href="link.href"
                class="text-sm hover:text-white hover:translate-x-1 inline-block transition-all duration-200"
              >
                {{ link.label }}
              </a>
            </li>
    ...
    <div class="border-t border-gray-800">
      <div class="container-max px-4 md:px-8 lg:px-16 py-6 flex flex-col md:flex-row items-center justify-between gap-3">
        <p class="text-sm">
          © {{ new Date().getFullYear() }} SaharSoft. Barcha huquqlar himoyalangan.
        </p>
...
const footerLinks = [
  {
    title: 'Xizmatlar',
    links: [
      { label: 'Web Dasturlash', href: '#services' },
      { label: 'Mobil Ilovalar', href: '#services' },
