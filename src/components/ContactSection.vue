    ...
    <div class="container-max">
      <div class="grid lg:grid-cols-2 gap-16 items-start">
        ...
        <div class="reveal-left">
          ...
          <p class="text-lg text-gray-600 leading-relaxed mb-10">{{ t('contact.subtitle') }}</p>
          ...
          <div class="space-y-4">
            ...
            >
              ...
              <div>
                <div class="text-sm font-semibold text-gray-500 mb-0.5">{{ t(`contact.info[${i}].label`) }}</div>
                <div class="text-gray-900 font-bold group-hover:text-primary-600 transition-colors">{{ t(`contact.info[${i}].value`) }}</div>
              </div>
            </a>
          </div>
          ...
          <div class="mt-8 p-6 bg-primary-50 rounded-2xl border border-primary-100">
            <div class="flex items-center gap-3 mb-3">
              ...
              <span class="font-bold text-gray-900">{{ t('contact.hours_title') }}</span>
            </div>
            <p class="text-gray-600">{{ t('contact.hours_weekdays') }} <strong class="text-gray-800">9:00 – 18:00</strong></p>
            <p class="text-gray-600">{{ t('contact.hours_saturday') }} <strong class="text-gray-800">10:00 – 15:00</strong></p>
            <p class="text-gray-500 text-sm mt-2">{{ t('contact.hours_telegram') }}</p>
          </div>
        </div>
        ...
        <div class="reveal-right">
          <div class="bg-white rounded-3xl border border-gray-200 shadow-xl p-8 lg:p-10">
            <h3 class="text-2xl font-bold text-gray-900 mb-6">{{ t('contact.form_title') }}</h3>
            ...
            <form @submit.prevent="submitForm" class="space-y-5">
              <div class="grid sm:grid-cols-2 gap-5">
                ...
                <div>
                  <label class="block text-sm font-semibold text-gray-700 mb-2">{{ t('contact.phone') }} *</label>
              ...
              <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">{{ t('contact.service') }}</label>
                <select v-model="form.service"
                  ...
                  <option v-for="(opt, i) in 7" :key="i" :value="t(`contact.service_options[${i}]`)">
              ...
              <div>
                ...
                <textarea v-model="form.message" required rows="4" :placeholder="t('contact.message_placeholder')"
                  class="w-full px-4 py-3.5 rounded-xl border border-gray-200 focus:border-primary-400 focus:ring-2 focus:ring-primary-100 outline-none transition-all text-gray-800 placeholder-gray-400 resize-none"></textarea>
              </div>
              ...
              <button type="submit" :disabled="submitted"
                ...
                :class="submitted ? 'bg-green-500 text-white cursor-default' : 'bg-gradient-to-r from-primary-600 to-blue-500 text-white hover:shadow-lg hover:shadow-primary-200 active:scale-95'"
              >
...
const contactMeta = [
  { href: 'tel:+998901234567', icon: 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z', iconBg: 'bg-green-100', iconColor: 'text-green-600' },
  { href: 'mailto:info@saharsoft.uz', icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', iconBg: 'bg-blue-100', iconColor: 'text-blue-600' },
  { href: '#', icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z', iconBg: 'bg-purple-100', iconColor: 'text-purple-600' },
]
