  ...
  <section id="team" class="section-padding bg-gradient-to-br from-gray-50 to-primary-50">
    <div class="container-max">
      <div class="text-center mb-16 reveal">
        ...
        <p class="text-xl text-gray-500 max-w-2xl mx-auto">{{ t('team.subtitle') }}</p>
      </div>
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        >
          <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 card-hover text-center">
            ...
            <p class="text-sm font-semibold text-primary-600 mb-3">{{ t(`team.members[${index}].role`) }}</p>
            <p class="text-sm text-gray-500 leading-relaxed mb-4">{{ t(`team.members[${index}].bio`) }}</p>
            <div class="flex flex-wrap justify-center gap-1.5 mb-5">
              <span v-for="skill in member.skills" :key="skill" class="text-xs px-2.5 py-1 bg-gray-100 text-gray-600 rounded-full">
                {{ skill }}
              </span>
            </div>
      ...
      <div class="mt-20">
        <div class="text-center mb-12 reveal">
          ...
          <p class="text-gray-500">{{ t('team.reviews_subtitle') }}</p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                <div class="font-bold text-gray-900">{{ t(`team.reviews[${index}].author`) }}</div>
                <div class="text-sm text-gray-500">{{ t(`team.reviews[${index}].company`) }}</div>
              </div>
            </div>
          </div>
        </div>
